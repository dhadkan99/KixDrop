...
export default function LostAndFoundPage() {
  ...
  return (
    <div className="bg-red-600 min-h-screen font-sans p-4 relative overflow-hidden text-white">
      {/* Header */}
      <header className="flex justify-between items-center px-6 py-4 relative z-20 border-b border-red-500">
        <motion.img
      ...
      <section className="relative flex items-center justify-center h-[calc(100vh-100px)]">
        ...
        >
          ...
          <p className="text-xs">LOST AND FOUND</p>
          <div className="flex space-x-2 mt-4">
            {["/assets/l2.png", "/assets/l1.png"].map((src, i) => (
              <motion.img
                key={i}
          ...
          <Card className="p-4 bg-transparent shadow-none border-none">
            <div className="border-8 border-white p-4 relative">
              <div className="border-2 border-white p-4 text-center">
                <h2 className="text-5xl font-bold">LOST & FOUND</h2>
                <img
                  src="/assets/Lp1.png"
                  alt="Lost and Found Poster"
      ...
      <motion.footer
        ...
        transition={{ duration: 0.5 }}
        viewport={{ once: true }}
        className="mt-20 text-center py-10 border-t border-red-500"
      >
